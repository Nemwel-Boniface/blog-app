...
RSpec.describe Post, type: :model do
  let(:author) { User.new(name: 'Faith', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Mexico.', posts_counter: 2) }

  subject do
    Post.new(user: author.id, title: 'Hello', text: 'This is my first post', likes_counter: 3, comments_counter: 4)
  end
